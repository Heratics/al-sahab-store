...
import { MapPin, Phone, Clock, Store, Navigation, Facebook } from 'lucide-react';
        ...
        <div className="bg-secondary rounded-3xl p-8 md:p-12 overflow-hidden border border-border shadow-lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                <div className="w-16 h-16 bg-card rounded-2xl flex items-center justify-center shadow-sm mb-6 border border-primary/10">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-card flex items-center justify-center shadow-sm shrink-0 border border-border">
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex w-full sm:w-auto justify-center items-center gap-2 px-5 sm:px-6 py-3 sm:py-4 bg-card text-foreground rounded-2xl sm:rounded-full text-sm sm:text-base font-bold shadow-sm border border-border hover:border-primary/40 hover:-translate-y-1 transition-all"
                  >
                    <Facebook className="w-5 h-5 text-primary" />
                    {t('Facebook Page', 'صفحة فيسبوك')}
                  </a>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl border-4 border-white dark:border-white/10 group"
            >
              <a 
                href="https://www.google.com/maps/place/%D8%A8%D9%88%D8%A7%D8%A8%D8%A9+%D8%A7%D9%84%D8%B4%D8%B9%D8%A8+%D9%84%D9%84%D8%AA%D8%AE%D9%81%D9%8A%D8%B6%D8%A7%D8%AA+%D8%A7%D9%84%D8%B9%D9%82%D8%A8%D8%A9%E2%80%AD/@29.5550022,35.0240359,360m/data=!3m1!1e3!4m6!3m5!1s0x15006f00648a785d:0x87defb259c2dd3!8m2!3d29.554538!4d35.023887!16s%2Fg%2F11x989cn75"
                target="_blank"
              ...
              >
                <div className="w-16 h-16 bg-card rounded-full flex items-center justify-center text-primary mb-3 shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              ...
              {/* Styled map graphic */}
              <div className="absolute inset-0 bg-[#e8eae6] dark:bg-[hsl(222_18%_22%)]">
                ...
                <div className="absolute top-1/4 left-0 right-0 h-4 bg-white opacity-40 dark:bg-white/20 rotate-12"></div>
                <div className="absolute top-1/2 left-0 right-0 h-8 bg-white opacity-50 dark:bg-white/25 -rotate-6"></div>
                <div className="absolute inset-y-0 left-1/3 w-6 bg-white opacity-40 dark:bg-white/20 rotate-6"></div>
                
                {/* Location Pin */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center">
                  <div className="w-20 h-20 bg-primary/20 rounded-full animate-ping absolute"></div>
                  <div className="w-12 h-12 bg-card rounded-full shadow-xl flex items-center justify-center relative z-10 border-2 border-primary">
                    <img 
